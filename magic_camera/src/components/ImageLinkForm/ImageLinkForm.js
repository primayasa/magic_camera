			...
			<div className="ma4 mt0">
				...
				<div className="center-content">
					<div className="form pa3 br3 shadow-5">
						...
						<button className="white b mr2 pv2 ph3 bn br2 bg-orange" onClick={onButtonSubmit} disabled={disableFind}>Find face</button>
						<button className="white b pv2 ph3 bn br2 bg-mid-gray" onClick={onInputClear} disabled={disableFind}>Clear</button>
					</div>
				</div>
			</div>
		);
